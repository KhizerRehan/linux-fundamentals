...
1. Copy the files `README.MD`, `ssh-config` and `ssh-private-key` into the directory named `.secrets` into your codespace. You can drag and drop those files into the browser.
